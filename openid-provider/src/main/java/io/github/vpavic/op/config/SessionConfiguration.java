...
public class SessionConfiguration {
	...
	private final ServerProperties.Session.Cookie sessionCookieProperties;

	private final HazelcastSessionProperties sessionProperties;

	private final HazelcastInstance hazelcastInstance;

	public SessionConfiguration(ServerProperties serverProperties, HazelcastSessionProperties sessionProperties,
			ObjectProvider<HazelcastInstance> hazelcastInstance) {
		this.sessionCookieProperties = serverProperties.getSession().getCookie();
